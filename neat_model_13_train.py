...
while True:
    ...
    def run_neat(config_path, save_path="best_genome2.pkl", generations=200, winrate_weight=0.6, pnl_weight=0.4):
        """
        ...
        def evaluate_genomes(genomes, config):
            ...
            for genome_id, genome in genomes:
                ...
                try:
                    ...
                    genome.fitness = max(weighted_fitness, 0)

                    # Print genome performance
                    print(f'Trader: {genome_id}, PNL%: {round(PNL, 2)}%, Winrate: {round(winrate * 100, 2)}%, '
                          f'Wins: {win}, Loss: {loss}, Profit: {round(total_profit, 2)}')
